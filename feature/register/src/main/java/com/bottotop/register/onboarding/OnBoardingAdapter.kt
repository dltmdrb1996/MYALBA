...
class OnBoardingAdapter(private val viewModel: OnBoardingViewModel) : RecyclerView.Adapter<OnBoardingAdapter.ViewHolder>() {

    class ViewHolder constructor(val binding: OnboardViewholderBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(pos : Int, viewModel : OnBoardingViewModel) {
            ...
            binding.apply {
                when(pos){
                    ...
                    3 -> {
                        ...
                        binding.btnGoRegister.isVisible()
                    }
                }
